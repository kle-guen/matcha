...
public class MessageService {
	...
	public void createMessage(final SendMessageDto sendMessageDto) {
		...
		if (blockService.isBlockedOrBlocker(sendMessageDto.receiverId)) {
			throw new ForbiddenResponse("You can't send a message to this user");
		}
		...
		WebSocketConfig.sendMessageToUser(sendMessageDto.receiverId, messageMapper.toMessageDto(message));
	}
